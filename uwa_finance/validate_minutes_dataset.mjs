...
const [researchers, publications, links, summaries, quality] = await Promise.all([
  read("uwa_finance_researchers.json"),
  read("uwa_finance_publications_ranked.json"),
  read("uwa_finance_researcher_publications.json"),
  read("uwa_finance_researcher_summary.json"),
  read("uwa_finance_data_quality.json"),
]);
