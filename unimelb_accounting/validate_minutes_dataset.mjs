...
const [researchers, publications, links, summaries, quality] = await Promise.all([
  read("unimelb_accounting_researchers.json"),
  read("unimelb_accounting_publications_ranked.json"),
  read("unimelb_accounting_researcher_publications.json"),
  read("unimelb_accounting_researcher_summary.json"),
  read("unimelb_accounting_data_quality.json"),
]);
