...
const COLLECTION_ID = "10c7b2a9-76da-5115-b275-96e65d024912";
...
await fs.writeFile(
  path.join(OUTPUT_DIR, "unimelb_accounting_publications.json"),
...
await fs.writeFile(path.join(OUTPUT_DIR, "unimelb_accounting_publications.csv"), `${csvRows.join("\n")}\n`, "utf8");
