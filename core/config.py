...
# core/config.py sits one folder below the repo root. It used to sit two
# (src/core/), so this was parent.parent.parent; left unchanged after the
# move it would point one level ABOVE the repo, and data/, output/ and
# cache/ would all quietly resolve outside it.
